...
testWebP(function (e) {
  ...
  t.addEventListener("submit", i => {
    ...
    if (l) {
      l.length > 14 && (l = l.substring(0, 14) + "..."), e.list.push(l), e.list.sort(), s(e.list, n), console.log(e.list), t.querySelector("[type='checkbox']:checked") && console.log("Добавляем любимый фильм");
    }
